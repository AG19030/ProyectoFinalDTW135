                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Lugar</label>
                                        <input type="text" maxlength="50" autocomplete="off" class="form-control" id="lugar-nuevo" placeholder="Lugar">
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Lugar</label>
                                        <input type="text" maxlength="50" autocomplete="off" class="form-control" id="lugar-editar" placeholder="Lugar">
                                    </div>

                                    <div class="form-group">
                                        <label>Descripción</label>
                                        <input type="text" maxlength="100" autocomplete="off" class="form-control" id="descripcion-editar" placeholder="Descripción">
                                    </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('admin/eventos/tabla') }}";
    ...
    <script>
        ...
        function nuevoEvento(){
            ...
            if(descripcion.length > 100){
                toastr.error('Máximo 100 caracteres para Descripción');
                return;
            }

            openLoading();
            var formData = new FormData();
            formData.append('nombre', event_name);
            formData.append('fecha', date);
            formData.append('lugar', location);
            formData.append('descripcion', description);

            axios.post(url+'/eventos/nuevo-evento', formData, {
            })
                .then((response) => {
                    closeLoading()

                    if (response.data.success === 1) {
                        toastr.error('Nombre Evento ya existe');
                    }
        ...
        function verInformacion(id){
            ...
            axios.post(url+'/eventos/info-evento',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function actualizar(){
            ...
            axios.post(url+'/eventos/editar-evento', formData, {
            })
                .then((response) => {
                    closeLoading()

                    if (response.data.success === 1) {
                        toastr.error('El Evento ya existe');
                    }
                    else if(response.data.success === 2){
        ...
        function borrar(){
            ...
            axios.post(url+'/eventos/borrar', formData, {
            })
                .then((response) => {
                    closeLoading()
