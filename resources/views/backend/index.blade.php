...
<div class="wrapper">
    ...
    <div class="content-wrapper" style=" background-color: #fff;">
        ...
        <iframe style="width: 100%; resize: initial; overflow: hidden; height: calc(100vh - 260px)" frameborder="0"  scrolling="" id="frameprincipal" src="{{ route($ruta) }}" name="frameprincipal">
        </iframe>
